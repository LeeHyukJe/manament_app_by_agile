...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/x/aaa/registration.js'), 'aaa resolves');
    });
    ...
    resolve('bbb', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/y/bbb/registration.js'), 'bbb resolves');
    });
    ...
    resolve('ccc', {
        ...
        t.error(err);
        t.equal(res, path.join(__dirname, '/node_path/x/ccc/registration.js'), 'ccc resolves');
    });
